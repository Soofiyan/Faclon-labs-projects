...
#if (HTTP_REQUEST == 0)
// url for http-get
#define HTTP_URL_ADDR   "https://us-central1-iot-data-15923.cloudfunctions.net/api/custom-data\0"//"http://www.quectel.com/\0"
#elif (HTTP_REQUEST == 1)
// url for http-post
#define HTTP_URL_ADDR   "https://us-central1-iot-data-15923.cloudfunctions.net/api/custom-data\0"//"http://www.quectel.com/\0"
#elif (HTTP_REQUEST == 2)
// url for http-file
#define HTTP_URL_ADDR   "https://us-central1-iot-data-15923.cloudfunctions.net/api/custom-data\0"//"http://124.74.41.170:5015/index.html\0"
#endif

// for http-post (HTTP_REQUEST=1)
#define HTTP_POST_MSG   "{\"test\":\"Hello!\"}\0"
