...
//TASK_ITEM(proc_subtask2,  subtask2_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
#endif
//#if 0
////TASK_ITEM(ADC_task,  ADC_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
////TASK_ITEM(GPS_task,  GPS_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
////TASK_ITEM(GSM_UPLOAD_task,  GSM_UPLOAD_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
//
//
//TASK_ITEM(proc_subtask4,  subtask4_id, 1*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
//TASK_ITEM(proc_subtask5,  subtask5_id, 1*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
